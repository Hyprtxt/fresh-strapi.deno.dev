  ...
  var t = /*#__PURE__*/ function (_e) {
    ...
    _createClass(t, [{
      ...
      value: function install() {
        ...
        var e = typeof window[t.LOADED_CALLBACK] === "undefined"
          ? function () {}
      ...
      value: function onFormValid() {
        ...
        window["grecaptcha"].execute(this.opts.siteKey, {
          ...
          _this2.hiddenTokenEle.setAttribute(
            "name",
            _this2.opts.hiddenTokenName,
          )
      ...
      value: function getScript() {
        ...
        return "https://www.google.com/recaptcha/api.js?" +
          "onload=".concat(t.LOADED_CALLBACK, "&render=").concat(
            this.opts.siteKey,
          ).concat(e)
      },
    }])
