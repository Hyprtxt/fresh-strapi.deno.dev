  ...
  var i = /*#__PURE__*/ function (_t) {
    ...
    _createClass(i, [{
      ...
      value: function install() {
        ...
        this.prevButton = typeof this.opts.prevButton === "string"
        ...
        this.nextButton = typeof this.opts.nextButton === "string"
      ...
      value: function goToPrevStep() {
        ...
        var e = this.opts.isStepSkipped
          ? this.stepIndexes.slice(0, this.currentStep).reverse().find(
            function (t, e) {
          ...
          if (t === "Valid") {
            ...
            if (_t2 >= _this4.numSteps) {
              ...
              var _e3 = _this4.opts.isStepSkipped
                ? _this4.stepIndexes.slice(_t2, _this4.numSteps).find(
                  function (t, e) {
