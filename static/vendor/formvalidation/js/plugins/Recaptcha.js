  ...
  var i = /*#__PURE__*/ function (_e) {
    ...
    _createClass(i, [{
      ...
      value: function install() {
        ...
        this.core.on("core.field.reset", this.fieldResetHandler).on(
          "plugins.icon.placed",
          this.iconPlacedHandler,
        ).registerFilter("validate-pre", this.preValidateFilter)
        var e = typeof window[i.LOADED_CALLBACK] === "undefined"
          ? function () {}
      ...
      value: function uninstall() {
        ...
        this.core.off("core.field.reset", this.fieldResetHandler).off(
          "plugins.icon.placed",
          this.iconPlacedHandler,
      ...
      value: function getScript() {
        ...
        return "https://www.google.com/recaptcha/api.js?onload=".concat(
          i.LOADED_CALLBACK,
          "&render=explicit",
        ).concat(e)
      },
      ...
      value: function onResetField(e) {
        if (
          e.field === i.CAPTCHA_FIELD && this.widgetIds.has(this.opts.element)
        ) {
